...
const Image = () => {
    ...
    return (
        <div>
            ...
            <p>Thank you for your interest in using Testforger. The following terms of service outline what the user can and cannot do regarding the use of the website: <a href={window.location.origin}>{window.location.origin}</a></p>
            ...
            <ul>
                <li>You may not use the Image Generator at /image to generate any inappropriate content.</li>
                ...
                <li>You must not steal the API key used for generating AI prompts that is on the public Github, or else you could potentially spam.</li>
            </ul>
